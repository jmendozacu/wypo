...
#foreach ($requests as $r) var_dump($r); exit;
        ...
        $shipping = $hl->getShippingMethods(true);
        ...
        foreach ($requests as $vId=>$vRequests) {
            ...
            $systemMethods = $hl->getMultiSystemShippingMethodsByProfile($vendor, true);
        ...
        $customerSelected = $methodCodes = array();
        ...
        if ($rates) {
            ...
            $method->setMethodTitle(Mage::helper('udropship')->__('Total'));
    ...
    public function getMyMethodPrice($cost, $request, $method='')
    {
        ...
        $freeShippingSubtotal = Mage::getStoreConfig('carriers/udropship/free_shipping_subtotal');

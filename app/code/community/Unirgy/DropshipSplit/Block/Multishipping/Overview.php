...
class Unirgy_DropshipSplit_Block_Multishipping_Overview
...
#echo "<pre>"; print_r($rates[$vId]); echo "</pre>";
    ...
    public function getItemHtml(Varien_Object $item)
    {
        if ($item instanceof Unirgy_DropshipSplit_Model_Cart_Vendor
            || $item->getQuoteItem() instanceof Unirgy_DropshipSplit_Model_Cart_Vendor
        ) {
            $qItem = !$item instanceof Unirgy_DropshipSplit_Model_Cart_Vendor
    ...
    {
        return $this->getUrl('*/*/overviewPost', array('form_key' => Mage::getSingleton('core/session')->getFormKey()));
    }
}
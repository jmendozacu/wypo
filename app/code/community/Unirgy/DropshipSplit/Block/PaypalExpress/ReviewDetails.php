...
class Unirgy_DropshipSplit_Block_PaypalExpress_ReviewDetails extends Mage_Paypal_Block_Express_Review_Details
{
...
//                    }
    ...
    public function getItemHtml(Mage_Sales_Model_Quote_Item $item)
    {
        if ($item instanceof Unirgy_DropshipSplit_Model_Cart_Vendor) {
            ...
            return $this->getLayout()->createBlock('udsplit/paypalExpress_vendor', $blockName)

...
if (isset($keyList['UNQ_TS_SIMPLE_COND_DEL_CUS'])) {
    $this->run("
ALTER TABLE `{$this->getTable('udtiership_simple_cond_rates')}`
...
if (isset($keyList['UNQ_TS_SIMPLE_COND_VEN_DEL_CUS'])) {
    $this->run("
ALTER TABLE `{$this->getTable('udtiership_vendor_simple_cond_rates')}`
...
if (isset($keyList['UNQ_TS_SIMPLE_DEL_CUS'])) {
    $this->run("
ALTER TABLE `{$this->getTable('udtiership_simple_rates')}`
...
if (isset($keyList['UNQ_TS_SIMPLE_VEN_DEL_CUS'])) {
    $this->run("
ALTER TABLE `{$this->getTable('udtiership_vendor_simple_rates')}`
...
if (isset($keyList['UNQ_TS_RATES_DEL_CUS_CAT'])) {
    $this->run("
ALTER TABLE `{$this->getTable('udtiership_rates')}`
...
if (isset($keyList['UNQ_TS_RATES_VEN_DEL_CUS_CAT'])) {
    $this->run("
ALTER TABLE `{$this->getTable('udtiership_vendor_rates')}`
...
if (isset($keyList['UNQ_TS_PROD_RATES_PROD_DEL_CUS'])) {
    $this->run("
ALTER TABLE `{$this->getTable('udtiership_product_rates')}`

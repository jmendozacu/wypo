...
class Unirgy_DropshipSellYours_Block_Adminhtml_SystemConfigField_SyFieldsetsConfig extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    public function __construct()
    {
        parent::__construct();
        if (!$this->getTemplate()) {
            $this->setTemplate('udsell/system/form_field/fieldsets_config.phtml');
        }
    }
    ...
    {
        return Mage::app()->getLayout()->getBlockSingleton('udsell/adminhtml_systemConfigField_syFieldsetsColumnConfig')
            ->setTemplate('udsell/system/form_field/fieldset_column_config.phtml')

...
class Mage_Sales_Model_Order_Invoice extends Mage_Sales_Model_Abstract
{
    ...
    public function sendEmail($notifyCustomer = true, $comment = '')
    {
		...
		if(file_exists(Mage::getBaseDir('media').'/invoices/'.$this->getIncrementId().'.pdf')){
		$mailer->addAttachment(Mage::getBaseDir('media').'/invoices/'.$this->getIncrementId().'.pdf',$this->getIncrementId().'.pdf');
		}
        if ($notifyCustomer) {

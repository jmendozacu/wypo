...
//        );
    ...
    public function sendEmail($notifyCustomer = true, $comment = '')
    {
		...
		if(file_exists(Mage::getBaseDir('media').'/creditmemos/'.$this->getIncrementId().'.pdf')){
		$mailer->addAttachment(Mage::getBaseDir('media').'/creditmemos/'.$this->getIncrementId().'.pdf',$this->getIncrementId().'.pdf');
		}
        if ($notifyCustomer) {

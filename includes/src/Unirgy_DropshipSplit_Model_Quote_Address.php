...
class Unirgy_DropshipSplit_Model_Quote_Address extends Mage_Sales_Model_Quote_Address
{
    ...
    public function setShippingMethod($method)
    {
        ...
        $this->setData('shipping_method', $method);
        $this->setShippingDescription(Mage::getStoreConfig('carriers/udsplit/title'));
        return $this;
    }

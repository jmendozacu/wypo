 ...
 */
class Unirgy_DropshipSellYours_Model_Rewrite1700_CatalogSearch_Resource_Fulltext_Engine extends Mage_Core_Model_Resource_Db_Abstract
{
    /**
     * Init resource model
     *
    ...
    public function udsellSaveEntityIndexes($storeId, $entityIndexes, $udsellStatus, $entity = 'product')
    {
        ...
        foreach ($entityIndexes as $entityId => &$index) {
            $data[] = array(
                ...
                'store_id'      => $storeId,
                'data_index'    => $index,
                'udsell_status'    => @$udsellStatus[$entityId]
            );
        }
